...
export class Overlay {
  ...
  renderAudio() {
    ...
    el.innerHTML =
      this.head('Audio', 'Calm instrumental music composed, performed, and produced by me') +
  ...
  renderVideo() {
    ...
    el.innerHTML =
      this.head('Video', 'Video projects exploring AI, editing, motion, and visual storytelling') +
  ...
  renderWeb() {
    ...
    el.innerHTML =
      this.head('Web', 'Websites and interactive web projects I’ve built') +
